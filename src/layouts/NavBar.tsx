          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-4 lg:space-x-8 xl:space-x-12 2xl:space-x-16">
              ...
              {isLoadingUser ? null : !isLoggedIn && !user ? (
                ...
                isLoggedIn &&
                user && (
                  <li className="hidden lg:flex gap-2 items-center bg-secondary dark:bg-darkSecondary text-gray-800 dark:text-gray-900 px-3 py-1 rounded">
                    <FiUser size={22} />
                    <p className="md:text-lg">{user.name}</p>
                    <button
