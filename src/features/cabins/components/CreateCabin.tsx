...
const CreateCabinForm = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      const res = await axios.post(
        "/api-proxy/api/cabins/createCabin",
        formData,
        {
      ...
      console.log("✅ Cabaña creada:", res.data);
      resetForm();
      setImageCount(1); // resetear cantidad de campos de imagen
      console.log("Valor de imageCount: ", imageCount);
  ...
  return (
    <div className="w-full max-w-lg sm:max-w-xl mx-auto bg-white text-black p-2 xs:p-4 sm:p-6 rounded-xl shadow-md">
