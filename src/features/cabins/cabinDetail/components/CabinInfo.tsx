      ...
      {cabin && (
        <>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div>
              <p className="font-semibold text-gray-700">Precio por noche</p>
              <p>${cabin.pricePerNight.toLocaleString("es-AR")}</p>
            </div>
            <div>
              <p className="font-semibold text-gray-700">Capacidad</p>
              <p>{cabin.maxGuests} huéspedes</p>
            </div>
            <div>
            ...
            <div>
              <p className="font-semibold text-gray-700">Asador</p>
              <p>{cabin.hasGrill ? "Sí" : "No"}</p>
            </div>
            <div>
              <p className="font-semibold text-gray-700">Cochera</p>
              <p>{cabin.hasGarage ? "Sí" : "No"}</p>
            </div>
            <div>
              <p className="font-semibold text-gray-700">Pileta</p>
              <p>{cabin.hasSwimmingPool ? "Sí" : "No"}</p>
            </div>
          </div>
          ...
          <div>
            ...
            {cabin.amenities.length > 0 ? (
              ...
              <p className="text-gray-500">No se especificaron comodidades.</p>
            )}
          </div>
        </>
      )}
...
// Igual que el anterior, pero con texto adaptado para modo dark
import React from "react";
import { CabinDetailProps } from "../types/cabinDetailTypes";
